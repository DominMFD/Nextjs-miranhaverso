...
const spidersImage: Record<string, StaticImageData> = {
...
export default function SpiderPicture({ spider }: IProps) {
  return (
    <Image
      src={spidersImage[spider.id]}
      alt={`${spider.name} (Universo-${spider.universe})`}
      priority
    />
  );
}
